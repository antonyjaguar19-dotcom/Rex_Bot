...
WORKFLOW_PATH = PROJECT_ROOT / "05_Config" / "workflows" / "ltx2_video_only_v1_api.json"
...
class Backend(VideoBackend):
    ...
    def __init__(self, config: dict):
        ...
        log.info(f"LTX-2 adapter initialized. Workflow loaded from {WORKFLOW_PATH.name}")
    ...
    def _build_workflow(self, prompt: str, negative_prompt: str,
        ...
        injected = {
            ...
            "sigmas": False, "compression": False,
        }
