...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage:")
        print("  python comfyui_kontext_base.py <prompt> [reference_image_path]")
        print('Example: python comfyui_kontext_base.py "a small boy with curly brown hair, blue shirt, red shorts, smiling"')
        sys.exit(1)
...
class Backend(ImageBackend):
    ...
    def generate(self, prompt, negative_prompt=None, aspect_ratio="9:16",
        ...
        result = generate(prompt=prompt, output_path=output_path,
                          ...
                          steps=effective_steps, reference_image=reference_image)
